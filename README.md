[![Run App VictorNguyen](https://github.com/vnguyen52/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/vnguyen52/GithubActions/actions/workflows/run-app.yaml)
